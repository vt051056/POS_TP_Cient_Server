...
implementation
uses  Dialogs,  USaleDoc, Controls, System.UITypes;
procedure Register;
begin
...
begin
  ...
  FTimeOut                   := 50;      // 30 sec until timeout
 ...
 Result := false;
  ...
  begin
    ...
    begin
      ...
      then
       begin
        F_SaleDoc.IsOnWeight:=False;
        F_SaleDoc.Timer1.Enabled:=False;
        F_SaleDoc.OnWeightClick;
...
(*      if MessageDlg('RS232: Время ожидания данных с весов истекло! Продолжить опрос?',
       ...
       //    F_SaleDoc.RS2321.Disconnect;
        //   F_SaleDoc.RS2321.Active:=False;
         //  F_SaleDoc.Timer1.Enabled:=False;
